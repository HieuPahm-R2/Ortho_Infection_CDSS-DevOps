...
This project is indexed by GitNexus as **Infras_Devops** (303 symbols, 288 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Infras_Devops/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Infras_Devops/clusters` | All functional areas |
| `gitnexus://repo/Infras_Devops/processes` | All execution flows |
| `gitnexus://repo/Infras_Devops/process/{name}` | Step-by-step execution trace |
...
This project is indexed by GitNexus as **Infras_Devops** (192 symbols, 196 relationships, 2 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
